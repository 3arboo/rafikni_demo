"""
Django settings for rafikni project.
...
SECRET_KEY = 'django-insecure-qu83lhred!f78#(2kzhg6txwuio=max=r)2i_b72h)dfngcw7^'
...
AUTHENTICATION_BACKENDS = [
    'core.backends.EmailAuthBackend',  # استبدل core باسم تطبيقك
    'django.contrib.auth.backends.ModelBackend',
]

AUTH_USER_MODEL = 'core.User'  # استبدل core باسم تطبيقك
